...
export function BriefPage() {
  ...
  return (
    <main className="page inner-page">
      <header className="page-title"><p className="eyebrow">每日 Brief · {brief.mode}</p><h1>今天的三条主线</h1><time>{brief.date}</time><p>{brief.headline}</p><small>生成于 {brief.generatedAt}</small></header>
